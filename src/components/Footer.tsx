        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <ScrollReveal delay={0}>
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                <img src={logo.src} alt="LAMORQ" className="h-10 w-auto brightness-200" />
                <span className="font-display text-xl font-bold">LAMORQ</span>
              </div>
              <p className="text-sm opacity-70 leading-relaxed">
                {t(
                  "100% natural therapeutic oils & herbal treatments. Made in Egypt with imported pure ingredients.",
                  "زيوت علاجية طبيعية 100% وعلاجات عشبية. صنع في مصر بمكونات نقية مستوردة."
                )}
              </p>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.1}>
            <div>
              ...
              <ul className="space-y-2 text-sm opacity-70">
                ...
                <li>
                  <Link href="/upcoming" className="hover:opacity-100 transition-opacity">
          ...
          <ScrollReveal delay={0.3}>
            <div>
              ...
              <ul className="space-y-2 text-sm opacity-70">
                <li>info@lamorq.com</li>
                <li>+20 100 000 0000</li>
                <li>{t("Cairo, Egypt", "القاهرة، مصر")}</li>
              </ul>
